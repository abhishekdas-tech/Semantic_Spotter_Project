...
answering questions from a bunch of Cisco Catalyst Switch Datasheets.

## 3. Document

1. The policy documents can be found in Datasheets folder.
...
- Clone the github repository
  ```shell
  $ git clone https://github.com/abhishekdas-tech/Semantic_Spotter_Project.git
  ```
- Open
  the notebook in jupyter or google colan and run all cells.